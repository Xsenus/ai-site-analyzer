...
_STANDARD_MODEL_PRICING_USD_PER_1M: Dict[str, ModelPricing] = {
    ...
    "gpt-5-pro": ModelPricing(input_per_1m=15.00, cached_input_per_1m=0.0, output_per_1m=120.00),
    ...
    "gpt-5.4-pro": ModelPricing(input_per_1m=30.00, cached_input_per_1m=0.0, output_per_1m=180.00),
    "gpt-5.5": ModelPricing(input_per_1m=5.00, cached_input_per_1m=0.50, output_per_1m=30.00),
    "gpt-5.5-pro": ModelPricing(input_per_1m=30.00, cached_input_per_1m=0.0, output_per_1m=180.00),
